...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'aida.adg007.kdns.fr')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiNTk0YmFlOTgtOGU0OC00MWY2LTg4MGEtOWRjZTMzOTRhYzRhIiwicyI6IllXSTFPREZoTkRjdE0yRXpOQzAwTVdVd0xXSm1NbVF0WkRkbU56SmtNVFJqWlRZNCJ9')      # 固定密钥token或json，留空将使用临时隧道
S5_PORT = os.environ.get('S5_PORT', '')          # SOCKS5 端口，默认不启用
HY2_PORT = os.environ.get('HY2_PORT', '')        # Hysteria2 端口，默认不启用
TUIC_PORT = os.environ.get('TUIC_PORT', '31035')      # TUIC 端口，默认不启用
