...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'ssh.adg007.kdns.fr')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiZWExNTBjZjctMjcxZi00ODVmLTgyODgtYTE3ZjgyMzY2ODI4IiwicyI6IllUYzFZbUZoWWpNdFptVmhaQzAwTldaaExUbGtaRFV0TXpKaU5HSmtNVE15Wm1VMyJ9')      # 固定密钥token或json，留空将使用临时隧道
