...
UUID = os.environ.get('UUID', 'f47b9c2e-8d3a-4e15-b6c1-7a9e2f04d8b3') # 节点和哪吒v1使用的UUID，默认固定值，建议自行生成一个唯一的UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'kerit.adg007.kdns.fr')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiYzc5MjQ4YjYtNjVkNC00ZWIxLWE2YzctMjU0NjJmM2RkYmY3IiwicyI6Ik56VmlZVFJqTkRRdFpHRTVNeTAwTVRobExXSXhOek10TW1FMk1tWmhNVEEyTVdVNSJ9')      # 固定密钥token或json，留空将使用临时隧道
...
CFIP = os.environ.get('CFIP', 'www.shopify.com')       # argo节点的优选域名或优选ip
